...
uint8_t realtimeBroadcast(uint8_t type, IPAddress client, uint32_t length, uint8_t *buffer, uint8_t bri=255, bool isRGBW=false, uint8_t artnet_outouts=1, uint16_t artnet_leds_per_output=1, uint8_t artnet_fps_limit=1, uint8_t color_order=0);
